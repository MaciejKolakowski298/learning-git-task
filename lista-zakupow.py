...
print(lista_zakupow)
print("Nie jestem fanem 'plastików' ale przyznaj, że jest piękna: https://www.roadracingworld.com/news/mv-agusta-superveloce-1000-combines-technology-style-performance/ ")
